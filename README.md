...
A curated list of amazingly awesome public source intelligence tools and resources.

Herkese açık kaynaklardan elde edilen bilgileri toplayan araçların kategoriler halinde listesi.

This list is a translated and edited version of [Awesome OSINT](https://github.com/jivoi/awesome-osint) . Huge thanks to the awesome-osint team. I find their list very useful so I'm translating in Turkish for it to be available to Turkish github users. 
...
Amazing-OSINT listesi kısmen [i-inteligence's](http://www.i-intelligence.eu) [OSINT Tools and Resources Handbook](http://www.i-intelligence.eu/open-source-intelligence-tools-and-resources-handbook/) kaynaklarından alınmıştır.

## [↑](#-Table-of-Contents) General Search

*Some useful search engines / bazı kullanışlı arama motorları*

* [Advangle](http://advangle.com)
* [Aol](http://search.aol.com)
* [Ask](http://www.ask.com)
* [Bing](http://www.bing.com)
* [DuckDuckGo](https://duckduckgo.com) - an Internet search engine that emphasizes protecting searchers' privacy. / gizlilik odakli bir arama motoru
* [Google Search](http://www.google.com) 
* [Instya](http://www.instya.com) tool for finding similar websites / benzer site bulma aracı

## [↑](#-Table-of-Contents) Main National Search Engines

*Localized search engines by country. / Ülkelere özel arama motorları*

* [Alleba (Philippines / Filipinler)](http://www.alleba.com) 
* [Baidu (China / Çin)](http://www.baidu.com) 
* [Eniro (Sweden / İsveç)](http://www.eniro.se)
* [Goo (Japan / Japonya)](http://www.goo.ne.jp)
* [Najdsi (Slovenia / Slovenya)](http://www.najdi.si)
* [Naver (South Korea / Güney Kore)](http://www.naver.com)
* [Onet.pl (Poland / Polonya)](http://www.onet.pl)
* [Orange (France / Fransa)](http://www.orange.fr)
* [Parseek (Iran)](http://www.parseek.com)
* [SAPO (Portugal / Portekiz)](http://www.sapo.pt)
* [Search.ch (Switzerland / İsviçre)](http://www.search.ch)
* [Seznam(Czech Republic / Çekya)](https://seznam.cz)
* [Walla (Israel / İsrail)](http://www.walla.co.il)
* [Yandex (Russia / Rusya)](http://www.yandex.com)

## [↑](#-Table-of-Contents) Specialty Search Engines

*Search engines for specific information or topics. / spesifik bir konu veya bilgi için kullanılabilecek arama motorları*

* [2lingual Search](http://www.2lingual.com)
* [BeVigil](https://bevigil.com/search) - Search for assets like Subdomains, URLs, Parameters in mobile applications / mobil uygulamalar hakkında bilgi elde edinme toolu
...
* [Shodan](https://www.shodan.io/) - Shodan is a search engine for the IOT(Internet of Things) that allows you to search variety of servers that are connected to the internet using various searching filters. / Nesnelerin Interneti'ni tarayıp çeşitli sunucular bulmanızı sağlayan bir arama motoru
...
*Search engines that scrape multiple sites (Google, Yahoo, Bing, Goo, etc) at the same time and return results. / Aynı anda birden çok arama motoruyla size sonuç veren siteler*
...
*Find websites that are similar. Good for business competition research. / Benzer site bulmanızı sağlayan araçlar. İş dünyasında rakip firmaları bulmak için kullanılabilir. *
...
*Search for data located on PDFs, Word documents, presentation slides, and more. / Çeşitli dokümanlarda bulunan verileri arayan araçlar*
...
*Search for all kind of files. / Her türlü belgeyi bulmanızı sağlayacak arama araçları*

* [FileChef](https://www.filechef.com/)
* [File Search Engine](https://www.filesearch.link/)
* [de digger](https://www.dedigger.com/) - is a website that allows you to find any types of files that are publicly avilable in a Google Drive. / Google Drive'da herkese açık olarak payalaşılmış dosyaları bulur
...
*Find information that has been uploaded to Pastebin & alternative pastebin-type sites / Çeşitli Pastebin sitelerindeki paylaşımları arama araçları*

* [PasteLert](http://andrewmohawk.com/pasteLert) - pastebin.com search / pastebin.com arama
* [cl1p](https://Cl1p.net)
* [codepad](http://codepad.org)
* [controlc](https://Controlc.com)
* [dpaste](https://Dpaste.com)
* [dpaste2](https://Dpaste.org)
* [doxbin](https://doxbin.net/) - A dox style pastebin ran by hackers / hackerlar tarafından yürütülen bir dox/pastebin sitesi
...
*Search by website source code / Site kaynak kodu arama motorları*

* [AnalyzeID](https://analyzeid.com/) - Find Other Websites Owned By The Same Person / Aynı kişiye ait siteleri bulma aracı
* [NerdyData](https://nerdydata.com) - Search engine for source code. / Kaynak Kod arama motoru
* [SearchCode](https://searchcode.com) - Help find real world examples of functions, API's and libraries across 10+ sources. / Fonksiyonlarin kütüphanelerin vs. kullanım örneklerini bulma aracı
* [grep.app](https://grep.app/) - Searches code from the entire github public repositories for a given specific string or using regular expression. / github herkese açık repolarda arama aracı
...
* [Audiense](https://www.audiense.com) - Tool to identify relevant audience, discover actionable insights and inform strategies to grow your business. / hedef kitle bulma vs. alanlarda kullanılabilecek bir araç
...
* [IDCrawl](https://www.idcrawl.com/) - Search for a name in popular social networks. / populer sosyal medyalarda isim arama
...
* [SocialGrep](https://socialgrep.com) - a Reddit search engine/analysis tool, "signals out of the social web of noise." / reddit arama aracı
...
* [MyTweetAlerts](https://www.mytweetalerts.com/) - A tool to create custom email alerts based on Twitter search. / twitter aramalarına göre uyarıcı kurma sitesi
...
* [Trends Predictions](https://trendspredictions.com/) - A tool for discovering new trending topics. / yeni trend olan konulari bulan bir site
...
* [Facebook Friend List Scraper](https://github.com/narkopolo/fb_friend_list_scraper) - Tool for scraping large Facebook friend lists without being rate-limited. / Facebook arkadaşlarını listeleyen bir araç
...
* [haveibeenzuckered](https://haveibeenzuckered.com/) - A large dataset containing 533 million Facebook accounts was made available for download. The data was obtained by exploiting a vulnerability that was, according to Facebook, corrected in August 2019. Check if a telephone number is present within the Facebook data breach. / Sızdırılan 500 milyon Facebook hesabına sizinki de dahil mi kontrol edebilirsiniz

### [↑](#-Table-of-Contents) Instagram

* [Hashtagify](http://hashtagify.me)
* [Iconosquare](http://iconosquare.com)
* [Osintgram](https://github.com/Datalux/Osintgram) - Osintgram offers an interactive shell to perform analysis on Instagram account of any users by its nickname.  / Instagram kullanıcı adından bilgi toplama
...
*Tools to help discover more about a reddit user or subreddit. / Reddit Araçları*

* [Imgur](http://imgur.com/search?q=) 
* [Mostly Harmless](http://kerrick.github.io/Mostly-Harmless/#features) - Mostly Harmless looks up the page you are currently viewing to see if it has been submitted to reddit. / Baktığınız site redditte paylaşılmış mı kontrol eder
* [Reddit Archive](http://www.redditarchive.com) - Historical archives of reddit posts. / Reddit post arşivleri
* [Reddit Suite](https://chrome.google.com/webstore/detail/reddit-enhancement-suite/kbmfpngjjgdllneeigpgjifpgocmfgmb) - Enhances your reddit experience. / Farklı bir reddit deneyimi sunar
* [Reddit User Analyser](https://atomiks.github.io/reddit-user-analyser/) - reddit user account analyzer. / reddit kullanici analizi
* [Subreddits](http://subreddits.org) - Discover new subreddits. / yeni subredditler keşfedin
* [Reddit Comment Search](https://redditcommentsearch.com/) - Analyze a reddit users by comment history. / Bir kullanicinin yorumlarini analiz edin
* [Universal Scammer List](https://universalscammerlist.com/) - This acts as the website-portion for the subreddit /r/universalscammerlist. That subreddit, in conjuction with this website and a reddit bot, manages a list of malicious reddit accounts and minimizes the damage they can deal. This list is referred to as the "USL" for short. / Dolandirici reddit hesaplarini listeler
* [Reddit Comment Lookup](https://randomtools.io/reddit-comment-search/) - Search for reddit comments by reddit username. / Kullanıcı adından reddit yorumlarını listeler


### [↑](#-Table-of-Contents) VKontakte

*Perform various OSINT on Russian social media site VKontakte. / Rus sosyal medyasi VK için araçlar*

* [Дезертир](http://vk.com/app3046467)
* [Barkov.net](http://vk.barkov.net)
* [Report Tree](http://dcpu.ru/vk_repost_tree.php)
* [Snradar](http://snradar.azurewebsites.net) - Search pictures by time and location they were taken / yer ve zaman ile resim arama
* [VK5](http://vk5.city4me.com)
* [VK Community Search](http://vk.com/communities)
* [VK Parser](http://vkparser.ru) - A tool to search for a target audience and potential customers. / potansiyel müşteri ve hedef kitle arama aracı
...
* [FTL](https://chrome.google.com/webstore/detail/ftl/lkpekgkhmldknbcgjicjkomphkhhdkjj?hl=en-GB) - Browser plugin that finds emails of people's profiles in LinkedIn. / LinkedIn hesaplarinin emailini bulan eklenti


### [↑](#-Table-of-Contents) Telegram

* [Telegago](https://cse.google.com/cse?q=+&cx=006368593537057042503:efxu7xprihg#gsc.tab=0&gsc.q=%20&gsc.page=1) - A Google Advanced Search specifically for finding public and private Telegram Channels and Chatrooms. / Telegram Kanal ve Grup arama araci
* [Telegram Nearby Map](https://github.com/tejado/telegram-nearby-map) - Webapp based on OpenStreetMap and the official Telegram library to find the position of nearby users. / Yakindaki telegram kullanicilarini bulma
...
* [Notey](http://www.notey.com) - Blog post search engine. / Blog arama motoru
...
* [Classmates](http://www.classmates.com) - Lise öğrencilerine odaklı arama motoru. 
* [CrunchBase](http://www.crunchbase.com) - Business focused information database / iş odaklı bilgi veritabanı
* [facesearch](http://facesaerch.com) - Google yüz arama motoru
* [Family Search](https://familysearch.org) 
* [Federal Bureau of Prisons - Inmate Locator (US)](http://www.bop.gov/inmateloc) - Search federal inmates incarcerated from 1982 to the present. / Amerikada hapse atılanların arama motoru
* [Fold3 (US Military Records)](http://www.fold3.com) - Search military records. Search filters limited with free access. Premium access requires subscription. / Amerika askeri kayıt arama
* [Judyrecords](https://www.judyrecords.com/) - Free. Nationwide search of 400 million+ United States court cases. / Amerika mahkeme arama motoru
* [The National Archives (UK)](http://www.nationalarchives.gov.uk) - Search UK national archives. / İngiltere resmi kayıt arama motoru
* [Reunion](http://reunion.com) - People search. Limited free info, premium data upsell. / İnsan arama motoru. Kısmi olarak ücretli
* [SearchBug](http://www.searchbug.com) - People search. Limited free info, premium data upsell. / İnsan arama motoru. Kısmi olarak ücretli
* [Spokeo](http://www.spokeo.com) - People search. Limited free info, premium data upsell. / İnsan arama motoru. Kısmi olarak ücretli
* [White Pages (US)](http://www.whitepages.com) - - People search. Limited free info, premium data upsell. / İnsan arama motoru. Kısmi olarak ücretli
* [ZabaSearch](https://www.zabasearch.com/)
* [JailBase](https://www.jailbase.com/) - is an information site that allows you to search for arrested persons you might know, and even get notified if someone you know gets arrested. / Tutuklanmış insanları arama motoru
* [Mugshots](https://mugshots.com/) Tutuklanma fotoğraf veritabanı

## [↑](#-Table-of-Contents) E-mail Search / E-mail Check

* [DeHashed](https://dehashed.com/) - Data breach search engine / Veri Sızıntısı arama motoru
* [LeakCheck](https://leakcheck.io/) - Data breach search engine / Veri Sızıntısı arama motoru
* [Email Address Validator](http://www.email-validator.net)
* [Email Format](http://email-format.com) - is a website that allows you to find email address formats used by different companies. / şirketlerin email formatlarını bulan araç 
* [EmailHippo](https://tools.verifyemailaddress.io) - is an email address verification platform that will check whether a given email address exist or not. / bir mailin var olup olmadığını bulan site
* [Email Permutator](https://www.polished.app/email-permutator/)
* [h8mail](https://github.com/khast3x/h8mail) - Password Breach Hunting and Email OSINT, locally or using premium services. Supports chasing down related email / Veri Sızıntısı arama motoru
* [Holehe](https://github.com/megadose/holehe)
* [Have I Been Pwned](https://haveibeenpwned.com) - Search across multiple data breaches to see if your email address has been compromised. / Veri Sızıntısı arama motoru
* [Hunter](https://hunter.io) - Hunter lets you find email addresses in seconds and connect with the people that matter for your business. / şirket email bulma aracı
* [MailTester](http://mailtester.com)
* [Peepmail](http://www.samy.pl/peepmail)
* [Pipl](https://pipl.com)
* [Reacher](https://reacher.email) - Real-time email verification API, written in Rust, 100% open-source. / email onaylama aracı
* [ReverseGenie](http://www.reversegenie.com/email.php) - a website used to look up names, addresses, phone numbers, or emails and anonymously discover information about yourself, family, friends, or old schoolmates. / isim adres vb. ile insanlar hakkinda bilgi toplayan bir araç
* [ThatsThem](https://thatsthem.com/reverse-email-lookup)
* [Toofr](https://www.toofr.com)
* [Verify Email](http://verify-email.org)
* [VoilaNorbert](https://www.voilanorbert.com) - Find anyone's contact information for lead research or talent acquisition. / insanlarin iletisim bilgilerini bulma
* [Ghunt](https://github.com/mxrch/GHunt) - Investigate Google emails and documents. / Google email arama motoru

## [↑](#-Table-of-Contents) Phone Number Research
* [Reverse Phone Lookup](http://www.reversephonelookup.com/) - Detailed information about phone carrier, region, service provider, and switch information. / telefon numarası hakkında bilgi edinme aracı
* [Spy Dialer](http://spydialer.com/) - Get the voicemail of a cell phone & owner name lookup. / telefon numarası hakkında bilgi edinme aracı
* [Twilio](https://www.twilio.com/lookup) - Look up a phone numbers carrier type, location, etc. / telefon numarası hakkında bilgi edinme aracı
* [Phone Validator](https://www.phonevalidator.com/index.aspx) - Pretty accurate phone lookup service, particularly good against Google Voice numbers. / telefon numarası hakkında bilgi edinme aracı
* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) - Advanced information gathering & OSINT framework for phone numbers / telefon numarası hakkında bilgi edinme aracı
...
* [MuckRack](http://muckrack.com) - Extensive database of U.S. government public records obtained through federal and state public records requests. Automated tool that will make public records requests and follow up until records are obtained on your behalf. / Amerikan devlet kayıtlarını araa
* [National Speakers Association](http://www.nsaspeaker.org)
* [Newswise](http://www.newswise.com)
* [Patent Attorneys/Agent Search](https://oedci.uspto.gov/OEDCI/) - Official listing of U.S. attorneys qualified to represent individuals in U.S. patent office proceedings. / Amerikan avukat veri tabanı
...
* [CrunchBase](https://www.crunchbase.com) - Detailed information on startup businesses, with a specific focus on funding sources and funding procedures used by specific businesses. / Startuplar hakkinda bilgi toplama
* [Data.com Connect](https://connect.data.com)
* [EDGAR U.S. Securities and Exchange Commission Filings](http://www.edgar-online.com) - Periodic reports and extensive corporate disclosures from all businesses publicly traded in the United States. / Amerikan şirketleri hakkında bilgi edinme
...
* [OpenCorporates](https://opencorporates.com) - Global search of registered corporate entities and their associated individual officers or investors. / Şirketler ve yatırımcılarını arama motoru
...
* [Vault](http://www.vault.com) - Well-known ranking of largest United States Corporations. / En büyük Amerikan şirketleri sıralaması
...
* [ahrefs](https://ahrefs.com) - A tool for backlink research, organic traffic research, keyword research, content marketing & more. / Anahtar kelime vs. arama motoru
...
* [BuiltWith](http://builtwith.com) - is a website that will help you find out all the technologies used to build a particular websites. / Sitelerin hangi teknolojilerle yapildigini gosteren site
...
* [Domain Tools](http://whois.domaintools.com) - Whois lookup and domain/ip historical data. / Whois aracı ( Ip hakkinda bilgi edinme)
...
* [IP Location](https://www.iplocation.net) - is used for mapping of an IP address or MAC address to the real-world geographic location of an Internet-connected computing or a mobile device. / Ip ile konum bulma
* [IP 2 Geolocation](http://ip2geolocation.com)
* [IP 2 Location](http://www.ip2location.com/demo.aspx)
* [IPFingerprints](http://www.ipfingerprints.com) - is used to find the approximate geographic location of an IP address along with some other useful / Ip ile konum bulma information including ISP, TimeZone, Area Code, State.
...
* [Netcraft Site Report](http://toolbar.netcraft.com/site_report?url=undefined#last_reboot) - is an online database that will provide you a report with detail information about a particular website and the history associated with it. / site hakkinda bilgi toplama
...
* [Pentest-Tools.com](https://pentest-tools.com/information-gathering/google-hacking) - uses advanced search operators (Google Dorks) to find juicy information about target websites. / site hakkinda bilgi toplama
...
* [Robtex](https://www.robtex.com) - is an IP address and domain name based researching websites that offers multiple services such as Reverse DNS Lookup, Whois, and AS Macros. / ip ile bilgi bulma 
...
* [Similar Web](https://www.similarweb.com) - Compare any website traffic statistics & analytics. / Site istatiklerini listeleme
...
* [URLVoid](http://www.urlvoid.com) - Analyzes a website through multiple blacklist engines and online reputation tools to facilitate the detection of fraudulent and malicious websites. / site guvenilirligini test etme
...
* [w3snoop](http://webboar.com.w3snoop.com) - is a website that gives you a free and comprehensive report about a specific website. / site hakkinda bilgi edinme 
* [Verisign](http://dnssec-debugger.verisignlabs.com)
* [ViewDNS.info](http://viewdns.info)
* [You Get Signal](http://www.yougetsignal.com)
* [WiGLE](https://wigle.net/) - Wi-fi "wardriving" database. Contains a global map containing crowdsourced information on the location, name, and other properties of wi-fi networks. Software available to download to contribute data to the public infoset. / haritadan herhangi bir konumdaki wifi aglari ile ilgili bilgi edinme
* [urlscan](https://urlscan.io/) -  is a free service to scan and analyse websites. / site analizi
...
* [Google Input Tools](https://www.google.com/inputtools/try) - Makes it easy to type in the language you choose, anywhere on the web. / Seçtiğiniz dilde yazmanıza yardımcı olur
...
* [IloveTyping](https://ilovetyping.com/english-to-hindi-typing) - Translate English to Hindi / İngilizce Hintçe çeviri
...
* [Sentence Stack](https://sentencestack.com/) - Sentence search engine with grammar check, translation, and idiom detection. / Cümle arama motoru
...
* [Unsplash](https://unsplash.com) - Free high-resolution photos. / bedava yüksek çözünürlüklü görseller
...
* [Frame by Frame](https://chrome.google.com/webstore/detail/frame-by-frame/cclnaabdfgnehogonpeddbgejclcjneh/) - Browser plugin that allows you to watch YouTube videos frame by frame. / Videolari kare kare izlemenizi saglayan chrome eklentisi
...
* [ccSUBS](http://ccsubs.com/) - Download Closed Captions & Subtitles from YouTube / Youtube altyazilari
* [YouTube Metadata](https://mattw.io/youtube-metadata/)
* [YouTube Geofind](https://mattw.io/youtube-geofind/)
* [Video Stabilization Methods](https://github.com/yaochih/awesome-video-stabilization)
* [Filmot](https://filmot.com/) - Search within YouTube subtitles. Indexing over 573 million captions across 528 million videos and 45 million channels. / Youtube altyazilari arama motoru
...
* [The Collection of Computer Science Bibliographies](https://liinwww.ira.uka.de/bibliography/index.html) - The CCSB is a collection of bibliographies of scientific literature in computer science from various sources, covering most aspects of computer science. / Bilişim hakkında yüzlerce kaynak
...
* [JSTOR](http://www.jstor.org) - Search over 10 million academic journal articles, books, and primary sources. / akademik makale arama motoru
* [Lazy Scholar](http://www.lazyscholar.org)
* [Leibniz Information Centre For Science and Technology University Library](https://www.tib.eu/en/search-discover/) - indexes all reports of German publicly funded projects and many scientific papers. / almanya bilimsel makale vs arama motoru
...
* [PubMed](http://www.ncbi.nlm.nih.gov/pubmed) - Search more than 27 millions citations for biomedical literature from MEDLINE, life science journals, and online books. / tıp bilimsel makale vs arama motoru
...
* [SAS Planet](http://www.sasgis.org/sasplaneta/)  - Software used to view, download and stitch satellite images. / Uydu fotoğraflarını düzenleme vs için araç 
...
* [Worldwide OSINT Tools Map](https://cipher387.github.io/osintmap/) - A global map of databases and OSINT sources by applicable location. / Ülkelere uygun OSINT araçlarını gösteren harita
...
* [Snopes](http://www.snopes.com) - The definitive Internet reference source for urban legends, folklore, myths, rumors, and misinformation. / Bilgi veya haberlerin doğruluğunu kontrol etme sitesi
...
* [Google Alerts](http://www.google.com/alerts) - A content change detection and notification service. / Bir içerikte değişiklik yapıldığında sizi uyaran site
...
* [Firefox](https://www.mozilla.org) - currently the best browser in my honest opinion / bence piyasadaki en iyi browser
...
* [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) - Tor is a free software that prevents people from learning your location or browsing habits by letting you communicate anonymously on the Internet. / Gizlilik odaklı bir browser. konumunuzu vs. her şeyi sitelerden saklamaya çalışır. 
...
* [A1 Website Download](http://www.microsystools.com/products/website-download) - Download entire websites to disk. / Siteleri cihaziniza indirme sitesi
...
* [HTTrack](http://www.httrack.com) - Allows you to download a World Wide Web site from the Internet to a local directory, building recursively all directories, getting HTML, images, and other files from the server to your computer. / Siteleri cihaziniza indirme sitesi
...
* [VPN Comparison by That One Privacy Guy](https://thatoneprivacysite.net/) - is a summary list of top best VPN services. / en iyi vpnler listesi
...
* [Convert Words to Time](https://wordstotime.com) - Converts the number of words in a presentation or speech to how many minutes it will take to read. / harf sayisindan bir metnin okunmasinin ne kadar süreceğini hesaplar
...
* [Chart.js](http://www.chartjs.org) - a javascript library that allows you to create charts easly / kolayca grafik oluşturmaya yarayan bir javascript kütüphanesi
...
* [Gimp](http://www.gimp.org) - is a free and open-source cross-platform image editor software that can be used as an alternative for Adobe Photoshop. / bedava fotoshop alternatifi
...
* [TinyPNG](https://tinypng.com) - is a tool that can be used to compress various images formats in to smaller size. / resimlerin hafizada kapladigi alani kucultur 
...
* [Unroll.me](https://unroll.me) - Easily unsubscribe in one click from email subscriptions. / email bültenlerinden vs. kolayca emailinizi çıkarmanıza yarar
...
* [ManualsLib](https://www.manualslib.com/) - Database of More Than 2.6M Manuals. / yaklaşık 3 milyona yakın kullanım kılavuzu veritabanı
...
* [PDF Shelter](https://pdfshelter.com/) - Unlimited, privacy-aware, PDF tools running locally on browser / gizliliğe önem veren pdf araçları
...
* [Cardsmith](http://cardsmith.co) - Build visual collaboration systems with the familiarity of sticky notes on a white board. / post-it etiketlerle dolu bir pano benzeri ortak çalışma alanları oluşturur
* [CloudApp](http://www.getcloudapp.com)
...
* [Telegram](https://telegram.org) - is a secure and fast cloud-based mobile and desktop messaging platform. / güvenli ve kullanışlı ayrıca isterseniz anonim mesajlaşma platformu
...
* [Gephi](https://gephi.org) - is an open-source graph and network visualization software. / açık kaynak kodlu grafik ve ağ görselleşirme aracı
...
* [KeePass Password Safe](http://keepass.info) - is a free and open-source password manager that uses the most secure encryption algorithms to safegard your passwords. / güvenli bir şifre yöneticisi
...
* [Proton Mail](https://protonmail.com) - one of the most popular secure email providers / en güvenli email sitelerinden biri
